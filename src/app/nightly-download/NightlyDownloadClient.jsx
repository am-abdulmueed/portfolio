 ...
 export default function NightlyDownloadClient() {
   ...
   const platforms = [
     { name: 'Android', icon: FaAndroid, url: downloadUrls.android, color: 'success', chipColor: 'success', description: 'APK for Android devices', fileType: '.apk' },
     { name: 'Windows', icon: FaWindows, url: downloadUrls.windows, color: 'primary', chipColor: 'primary', description: 'Installer for Windows', fileType: '.msi' },
     { name: 'Linux (Deb)', icon: FaLinux, url: downloadUrls.linuxDeb, color: 'warning', chipColor: 'warning', description: 'Deb package - x86_64 only', fileType: '.deb' },
     { name: 'Linux (Rpm)', icon: FaLinux, url: downloadUrls.linuxRpm, color: 'warning', chipColor: 'warning', description: 'Rpm package - x86_64 only', fileType: '.rpm' },
     { name: 'Linux (AppImage)', icon: FaLinux, url: downloadUrls.linuxAppImage, color: 'warning', chipColor: 'warning', description: 'AppImage - x86_64 only', fileType: '.AppImage' },
     { name: 'macOS', icon: FaApple, url: downloadUrls.macos, color: 'default', chipColor: 'default', description: 'Installer for macOS', fileType: '.dmg' },
   ];
       ...
       <div className="relative isolate px-6 py-20 lg:px-8">
         ...
         <div className="mx-auto max-w-2xl text-center py-32 sm:py-48 lg:py-56">
           ...
           <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
             {countdown === 0 ? 'Ready to download!' : `Please wait ${countdown} second${countdown !== 1 ? 's' : ''}...`}
           </p>
           <div className="mb-8">
           ...
           <p className="text-sm text-gray-500/80">
             🔒 This is a secure download from muxio
           </p>
         </div>
       </div>
     </section>
