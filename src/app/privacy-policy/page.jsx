    ...
    <div className="container mx-auto px-4 py-8 lg:px-16 md:px-16 sm:px-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:text-xl prose-headings:font-semibold prose-headings:my-4 prose-p:my-3 prose-a:text-blue-500 prose-a:no-underline hover:prose-a:underline">
          <p>Welcome to muxio!</p>

          <p>At muxio (hereinafter referred to as &quot;us,&quot; &quot;we,&quot; or &quot;our&quot;), we respect the privacy of our visitors and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.</p>
          ...
          <p>We use Google AdSense to display advertisements on muxio.</p>
          <ul>
          ...
          <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. muxio aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
